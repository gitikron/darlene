...
import AD_STOCK_TYPE from "./components/admin/stock_type.vue";
import AD_STOCK_HISTORY from "./components/admin/stock_history.vue";
import AD_STOCK_INDEX from "./components/admin/stock_index.vue";
import AD_STOCK_EXCEL from "./components/admin/stock_excel.vue";
...
createApp(App)
    ...
    .component('ADSTOCKHISTORY', AD_STOCK_HISTORY)
    .component('ADSTOCKINDEX', AD_STOCK_INDEX)
    .component('ADSTOCKEXCEL', AD_STOCK_EXCEL)
    .mount("#app")