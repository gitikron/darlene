<template>
  <div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        >
          ...
          >
            <span
              ...
              v-if="personal.position === 'admin'"
              >Admin Dashbord</span
            >
            <span
              class="fs-5 d-none d-sm-inline"
              v-if="personal.position === 'manager'"
              >Manager Dashbord</span
            >
          </a>
          <ul
          ...
          >
            <li class="nav-item d-flex w-100 mt-1 mb-1">
              <button class="navbar-toggler" @click="load = 'index'">
                <span
                  class="material-symbols-outlined mx-auto fs-6 text-white pt-1"
                  >nest_display</span
                >
                <span class="ms-1 d-none d-sm-inline link-light hover"
                  >Index</span
                >
              </button>
            </li>
            ...
            <li
              class="nav-item w-100 mt-1 mb-1"
              v-if="personal.position === 'manager'"
            >
          ...
          <div class="dropdown pb-4">
            <a
              ...
              aria-expanded="false"
            >
              <span class="material-symbols-outlined mx-auto px-0"
            ...
            >
              <li>
                <a class="dropdown-item" @click="load = 'changePassword'"
                  >Change password</a
                >
              </li>
              <li>
              ...
              <li>
                <a class="dropdown-item" @click="this.singOut()">Sign out</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="col py-3">
        <ADINDEX
          class="container card d-flex justify-content-center px-2 pt-2"
          v-if="load === 'index'"
        />
        <ADOPD
          class="container card d-flex justify-content-center px-2 pt-2"
        ...
        >
          ...
          <button
            class="btn btn-sm btn-success mt-3 mb-3"
            @click="
              Repass(
                personal.username,
  ...
  methods: {
    Repass(index, password1, password2) {
      if (password1.length <= 7) {
        ...
        axios
          .patch(`${DB_URL}/auth/${index}.json`, { password: newPass })
          .then((result) => {
            this.changePassword.password1 = "";
            this.changePassword.password2 = "";
            alert("Successfuly");
    ...
    initfirebase() {
      ...
      var serviceAccount = require("../../databasedarlene-firebase-adminsdk-1lw74-e084ef8af5");
      admin.initializeApp({
