<template>
  <div class="d-flex justify-content-center mt-10">
    <div class="card w-300px-login">
      ...
      <label class="d-flex justify-content-center"><span class="material-symbols-outlined">person</span>
      <input type="text" class="from-control input-control" placeholder="Username"></label>
