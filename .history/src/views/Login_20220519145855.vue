      ...
      axios
        ...
        .then((result) => {
          if (result.status == 200) {
            ...
            this.session.setSession(result.data.username)
            //sessionStorage.setItem('2k-token', base64.encode(result.data.username));
             console.log(base64.decode(sessionStorage.getItem("2k-token")))
