  ...
  <div>
    <nav class="navbar navbar-expand navbar-dark navbar-sm bg-dark fixed-top">
      <div class="container-fluid">
        <span class="navbar-brand" href="#">&nbsp;Manager Dashbord</span>
      </div>
    </nav>
    ...
    <nav class="navbar navbar-expand navbar-dark navbar-sm bg-dark fixed-bottom">
      <div class="container-fluid">
       <button type="button" class="btn btn-outline-light" @click="load='admin_tbl'">Account</button>
       <button type="button" class="btn btn-outline-light" @click="load='finance_tbl'">Finance</button>
       <button type="button" class="btn btn-outline-light" @click="load='finance_tbl'">Commission</button>
       <button type="button" class="btn btn-outline-light" @click="load='finance_tbl'">Part time MD</button>
      </div>
    </nav>
  </div>
</template>
