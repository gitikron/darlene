<template>
  <div>
      ...
      <div  class="container d-flex justify-content-center">
       ...
       <button type="button" class="btn btn-warning btn-sm" mx-0 px-0 @click="lload='finance_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">delete</span>
         <span class="fs-custom">COMM</span>
         </button>
        <button type="button" class="btn btn-warning btn-sm mx-0 px-0" @click="load='finance_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">delete</span>
         <span class="fs-custom">PTMD</span>
         </button>
       <button type="button" class="btn btn-warning btn-sm mx-0 px-0" @click="logout()">
