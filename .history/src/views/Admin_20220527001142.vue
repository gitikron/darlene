...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <a href="/#/admin" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                    <span class="fs-5 d-none d-sm-inline" v-if="personal.position==='admin'">Admin Dashbord</span>
                    <span class="fs-5 d-none d-sm-inline" v-if="personal.position==='manager'">Manager Dashbord</span>
                </a>
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li class="nav-item d-flex w-100 mt-1 mb-1" >
                        <button class="navbar-toggler" @click="load='index'">
                    ...
                    <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='opd'">
                    ...
                    <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='couse'">
                     ...
                     <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='items'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">window</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">Items</span>
                        </button>
                    </li>
                  <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='stock'">
                    ...
                    <li class="nav-item w-100  mt-1 mb-1"  v-if="personal.position==='manager'">
                        <button class="navbar-toggler" @click="load='Accounting'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">credit_score</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">Pay setting</span>
                        </button>
                    </li>
                    <li class="nav-item w-100  mt-1 mb-1" v-if="personal.position==='manager'">
                        <button class="navbar-toggler" @click="load='admin'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">engineering</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">Admin account</span>
                        </button>
                    </li>
                    <li class="nav-item w-100  mt-1 mb-1" v-if="personal.position==='manager'">
                        <button class="navbar-toggler" @click="load='md'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">health_and_safety</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">MD account</span>
                        </button>
                    </li>
                    <li class="nav-item w-100  mt-1 mb-1" v-if="personal.position==='manager'">
                        <button class="navbar-toggler" @click="load='sale'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">settings_accessibility</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">Sale account</span>
                        </button>
                    </li>
                    <li class="nav-item w-100  mt-1 mb-1" v-if="personal.position==='manager'">
                        <button class="navbar-toggler" @click="load='setting'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">settings</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">Setting</span>
                        </button>
                    </li>
                </ul>
        ...
        <div class="col py-3">
            ...
            <ADINDEX class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='index'"/>
            ...
            <ADITEM class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='items'"/>
            <ADSTOCK class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='stock'"/>
            <ADACC class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='Accounting'"/>
            <ADADACCOUNT class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='admin'"/>
            <ADMDACCOUNT class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='md'"/>
            <ADSALEACCOUNT class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='sale'"/>
            <ADSETTING class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='setting'"/>
            <div class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='changePassword'">
              ...
              <label for="Role"  class="mt-1">
                Position :
                <input type="text" class="form-control" placeholder="Name" v-model="personal.position" disabled/>
              </label>
...
export default {
  ...
  mounted() {
    if(this.Setting.main==''){
      axios.get(`${DB_URL}/setting.json`).then((result) => {
        this.$store.dispatch("setSetting", result.data);
        this.Setting={
                      main:this.$store.getters.getSetting.main,
                      lineStock:this.$store.getters.getSetting.lineStock,
                      lineAccount:this.$store.getters.getSetting.lineAccount,
