<template>
  <div>
      ...
      <div  class="container d-flex justify-content-center">
               <button type="button" class="btn btn-warning btn-sm" @click="lload='finance_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">payments</span><br>
         <span class="fs-custom">รอจ่าย</span>
         </button>
        <button type="button" class="btn btn-warning btn-sm" @click="lload='admin_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">manage_accounts</span><br>
         <span class="fs-custom">user</span>
         </button>
        <button type="button" class="btn btn-warning btn-sm" @click="lload='finance_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">price_check</span><br>
         <span class="fs-custom">คชจ.ย่อย</span>
         </button>
       <button type="button" class="btn btn-warning btn-sm" @click="lload='finance_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">receipt</span><br>
         <span class="fs-custom">ค่าคอม</span>
         </button>
        <button type="button" class="btn btn-warning btn-sm" @click="load='finance_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">receipt</span><br>
         <span class="fs-custom">หมอ-pt</span>
         </button>
       <button type="button" class="btn btn-warning btn-sm" @click="logout()">
         <span class="material-symbols-outlined mx-0 px-0">delete</span><br>
