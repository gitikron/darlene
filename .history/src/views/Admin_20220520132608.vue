...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item w-100  mt-1 mb-1">
                        <button class="btn btn-dark btn-sm  w-100" @click="load=''">
        ...
        <div class="col py-3">
            ...
            <ADOPD class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='admin'"/>
            <ADCOUSE class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='admin'"/>
            <ADSTOCK class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='admin'"/>
