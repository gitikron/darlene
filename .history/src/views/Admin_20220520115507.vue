...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <div class="container card d-flex justify-content-center px-2 pt-2">
              ...
              <label for="Password">
                New Password :
                <input type="text" class="form-control" placeholder="New Password" v-model="changePassword.password1" />
              </label>
              <label for="Confirm Password">
                Confirm Password :
                <input type="text" class="form-control" placeholder="Confirm Password" v-model="changePassword.password2" />
              </label>
              <button class="btn btn-sm btn-success mt-3 mb-3">Submit</button>
            </div>
        </div>
    </div>
</div>
