<template>
  <div>
      ...
      <div class="container-fluid">
        <button type="button" class="btn btn-warning btn-sm" @click="load='finance_tbl'">PAYINDEX</button>
       ...
       <button type="button" class="btn btn-warning btn-sm" @click="load='finance_tbl'">PTMD</button>
       <button type="button" class="btn btn-outline-warning btn-sm text-white" @click="logout()">logout</button>
      </div>
    </nav>
    </div>
