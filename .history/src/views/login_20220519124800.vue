...
<div>
    ...
    <div class="card w-300px-login">
      <div class="row">
        <div class="col-1 d-flex">
          <span class="material-symbols-outlined mt-2 mb-2 ml-2">person</span>
        </div>
         <div class="col-11">
          <input type="text" class="from-control input-control w-95" placeholder="Username" v-model="auth.username">
        </div>
      </div>
  ...
  <div class="d-flex justify-content-center"> <div class="alert alert-danger alert-size" role="alert" v-if="snackbar===true">{{text}}</div></div>
