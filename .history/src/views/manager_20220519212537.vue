<template>
  <div>
      ...
      <div class="container-fluid">
        <button type="button" class="btn btn-primry btn-sm" @click="load='finance_tbl'">PAYINDEX</button>
       <button type="button" class="btn btn-primry btn-sm" @click="load='admin_tbl'">Account</button>
       <button type="button" class="btn btn-primry btn-sm" @click="load='finance_tbl'">Finance</button>
       <button type="button" class="btn btn-primry btn-sm" @click="load='finance_tbl'">Commission</button>
       <button type="button" class="btn btn-primry btn-sm" @click="load='finance_tbl'">PTMD</button>
      </div>
    </nav>
    </div>
