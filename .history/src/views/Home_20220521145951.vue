...
<div>
  ...
  <div class="container-fluid">
    ...
    <button class="btn btn-sm btn-dark text-end" @click="login()">login</button>
  </div>
    </nav>    
    <div class="container mt-3">
      <button class="btn btn-sm btn-dark m-2" @click="test()">post</button>
      <button class="btn btn-sm btn-dark m-2" @click="recive()">recive</button>
    </div>
