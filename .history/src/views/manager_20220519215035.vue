<template>
  <div>
      ...
      <div class="container-fluid">
       ...
       <button type="button" class="btn btn-warning btn-sm" @click="load='finance_tbl'">PT</button>
       <button type="button" class="btn btn-warning btn-sm" @click="logout()">logout</button>
      </div>
    </nav>
     <nav class="navbar navbar-expand navbar-primary navbar-sm bg-warning fixed-top pt-2">
      <div class="container-fluid">
        <button type="button" class="btn btn-warning btn-sm" @click="load='finance_tbl'">INDEX</button>
       <button type="button" class="btn btn-warning btn-sm" @click="load='admin_tbl'">Account</button>
       <button type="button" class="btn btn-warning btn-sm" @click="load='finance_tbl'">Finance</button>
