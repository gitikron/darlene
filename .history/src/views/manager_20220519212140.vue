<template>
  <div>
      ...
      <div class="container-fluid">
       ...
       <button type="button" class="btn btn-outline-light btn-sm" @click="load='finance_tbl'">PTMD</button>
       <button type="button" class="btn btn-outline-light btn-sm" @click="load='finance_tbl'">PAYINDEX</button>
      </div>
    </nav>
    </div>
