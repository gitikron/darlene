<template>
  <div>
      ...
      <div  class="container d-flex justify-content-center">
               <button type="button" class="btn btn-dark btn-sm mx-auto" @click="load='finance_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">payments</span><br>
         <span class="fs-custom">รอจ่าย</span>
         </button>
        <button type="button" class="btn btn-dark btn-sm mx-auto" @click="load='admin_tbl'">
         <span class="material-symbols-outlined mx-0 px-0">admin_panel_settings</span><br>
         <span class="fs-custom">Admin</span>
         </button>
        <button type="button" class="btn btn-dark btn-sm mx-auto" @click="load='admin_tbl'">
       ...
       <button type="button" class="btn btn-dark btn-sm mx-auto" @click="logout()">
