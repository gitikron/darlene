<template>
  <div class="d-flex justify-content-center mt-10">
    <div class="card w-300px-login">
      <label for=""><span class="material-symbols-outlined mt-2 mb-2">person</span>login</label>
      <input type="text" class="from-control input-control" placeholder="Username">
      <input type="password" class="from-control input-control" placeholder="Password">
      <div class="mt-2 mb-3">
      <button class="btn btn-success btn-sm w-95">login</button>
      </div>
    </div>
  </div>
</template>
