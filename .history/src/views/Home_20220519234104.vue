...
export default {
  ...
  methods: {
    ...
    async recive() {
      await axios
        .post(
          `${DB_url}/couse/${this.recives.username}.json`,
          this.recives
        )
        .then((result) => {
          console.log(result.data);
     ...
     async recive2() {
        ...
        .post(
         ...
         {username:this.recives.username,name:this.recives.name,couse:this.recives.couse,amount:this.recives.amount}
        )
        .then((result) => {
          console.log(result.data);
        })
        .catch((err) => {
         ...
         await axios
        .post(
          `${DB_url}/finance/${this.recives.createYear}/${this.recives.createMonth}.json`,
          {username:this.recives.username,name:this.recives.name,couse:this.recives.couse,amount:this.recives.amount}
        )
        .then((result) => {
          console.log(result.data);
        ...
        .catch((err) => {
         ...
         await axios
        .post(
          `${DB_url}/finance/${this.recives.createYear}.json`,
          {username:this.recives.username,name:this.recives.name,couse:this.recives.couse,amount:this.recives.amount}
        )
        .then((result) => {
          console.log(result.data);
