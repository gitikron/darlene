<template>
  <div class="bg-dark box">
    <div class="d-flex justify-content-center mt-5">
      <div class="card w-300px-login bg-light">
        <div class="row mt-3">
...
export default {
  ...
  methods: {
    ...
    async CheckDB() {
      await axios.get(`https://linenotify-c.herokuapp.com/login/${this.auth.username}`)
        .then((result) => {
          if (result!='') {
            ...
            this.preset.position = result.data.position;
