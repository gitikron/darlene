            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <div class="dropdown pb-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                      <li><a class="dropdown-item" @click="load='changeName'">Change name</a></li>
        ...
        <div class="col py-3">
            ...
            <div class="container card d-flex justify-content-center px-2 pt-2" v-if="load==='changePassword'">
              ...
              <label for="Password"  class="mt-1">
                New Password :
                <input type="text" class="form-control" placeholder="New Password" v-model="changePassword.password1" required/>
              </label>
              <label for="Confirm Password"  class="mt-1">
                Confirm Password :
                <input type="text" class="form-control" placeholder="Confirm Password" v-model="changePassword.password2" required/>
              </label>
              <button class="btn btn-sm btn-success mt-3 mb-3" @click="changePassword(personal.username,changePassword.password1,changePassword.password2)">Submit</button>
            </div>
        </div>
    </div>
</div>
...
export default {
  ...
  methods: {
    changePassword(index,password1,password2){
