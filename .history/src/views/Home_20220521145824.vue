...
<div>
  ...
  <div class="container-fluid">
    ...
    <div class="container container-fluid d-block justify-content-center">
      <button class="btn btn-sm btn-dark" @click="test()">post</button>
      <button class="btn btn-sm btn-dark" @click="recive()">recive</button>
    </div>
