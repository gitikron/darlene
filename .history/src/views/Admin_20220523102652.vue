            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item w-100  mt-1 mb-1">
                        ...
                        <button class="btn btn-dark btn-sm w-100" @click="load='couse'"><li class="nav-item w-100  mt-1 mb-1">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">window</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">Couse</span> </li>
                        </button>
