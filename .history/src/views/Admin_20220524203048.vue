                  ...
                  <li class="nav-item w-100  mt-1 mb-1">
                    ...
                    <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='setting'">
                             ...
                             <span class="ms-1 d-none d-sm-inline link-light hover">ADMIN ACCOUNTS</span>
                        </button>
                    </li>
                    <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='setting'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">settings</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">MD ACCOUNTS</span>
                        </button>
                    </li>
                    <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='setting'">
                             <span class="material-symbols-outlined mx-auto fs-6 text-white pt-1">settings</span>
                             <span class="ms-1 d-none d-sm-inline link-light hover">SALE ACCOUNTS</span>
                        </button>
                    </li>
                    <li class="nav-item w-100  mt-1 mb-1">
                        <button class="navbar-toggler" @click="load='setting'">
