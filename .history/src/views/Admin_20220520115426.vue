    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <div class="container card d-flex justify-content-center px-2 pt-2">
              ...
              <label for="Password">
                Password :
                <input type="text" class="form-control" placeholder="Username" v-model="changePassword.password1" />
              </label>
              <label for="Confirm Password">
                Confirm Password :
                <input type="text" class="form-control" placeholder="Username" v-model="changePassword.password2" />
              </label>
