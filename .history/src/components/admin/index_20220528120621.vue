                  ...
                  <tbody>
                    <tr v-for="item,index in OPD" :key="index">
                      ...
                      <td class="fs-res mx-0 px-0">
                        <button class="btn btn-sm fw-bold material-symbols-outlined" >add_to_queue</button>
                      </td>
                      <td class="fs-res mx-0 px-0">
                        <button class="btn btn-sm fw-bold fs-res material-symbols-outlined" @click="selectSale(index,item)">point_of_sale</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
