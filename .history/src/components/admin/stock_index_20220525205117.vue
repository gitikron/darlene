      ...
      >
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0 text-center"><input type="text" class="form-control"><button class="btn btn-success">></button></td>
            <td class="fs-res mx-0 px-0 text-center"><input type="text" class="form-control row-cols-5"><button class="btn btn-danger">></button></td>
