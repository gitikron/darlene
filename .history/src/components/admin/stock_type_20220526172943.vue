  ...
  <div>
    ...
    <div v-if="createControl===true">
      ...
      <input type="text" class="form-control" placeholder="ชื่อประเภท" v-model="data.type">
       <label for="typename">หน่วย</label>
       <input type="text" class="form-control" placeholder="หน่วย" v-model="data.unit">
      <div class="d-flex justify-content-end m-2">
      ...
      <table class="table table-hover mt-2"  id="datatable" cellspacing="0" width="100%">
        <thead>
          <tr class="px-0">
            ...
            <th class="fs-res mx-0 px-0 text-center">หน่วย</th>
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0 text-center">{{item.unit}}</td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- body -->
          <label for="typename">ประเภท</label>
          <input type="text" class="form-control" placeholder="ประเภท" v-model="edit.arr.type">
          <label for="typename">หน่วย</label>
          <input type="text" class="form-control" placeholder="หน่วย" v-model="edit.arr.unit">  
          <!-- body -->
        </div>
