...
export default {
  ...
  methods: {
   post() {
const url = 'https://notify-bot.line.me/oauth/authorize?response_type=code&client_id='+command.Client_ID+'&redirect_uri=https://theduckcreator.in.th/notifyredirect&scope=notify&state=' + userid
     axios.get(url)
// axios({
//     method: 'post',
