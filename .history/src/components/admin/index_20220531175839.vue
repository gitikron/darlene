    ...
    <div class="block-center">
      <div class="card block-1">
        ...
        <div class="float-start" v-if="load==='couse'">
          ...
          <button class="btn btn-sm btn-warning" @click="selected(index)" :disabled="item.select===true">เลือก</button>
          <button class="btn btn-sm btn-danger mt-1" @click="selectedOut(index)" :disabled="item.select===false">ลบ</button>
          </div>
          </div>
