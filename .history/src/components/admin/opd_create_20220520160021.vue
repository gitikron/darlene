...
<div>
    {{newOpd}}
      ...
      <div class="form-group row mt-2">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" id="CD" placeholder="Disease" v-model='newOpd.Disease' >
        </div>
        <div class="col-sm-2 mt-1">
      ...
      <div class="form-group row mt-2">
        <label for="sex" class="col-sm-2 col-form-label">ID</label>
        <div class="col-sm-8">
          <input type="text" class="form-control" id="CD" placeholder="เลขประจำตัวประชาชน" v-model='newOpd.Disease' >
        </div>
        <div class="col-sm-2 mt-1">
          <button class="btn btn-outline-dark btn-sm w-100" @click="CdControl()">NCDs</button>
          </div>
