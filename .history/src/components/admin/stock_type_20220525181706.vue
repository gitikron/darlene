<template>
  <div>
    ...
    <div v-if="createControl===true">
      <label for="typename">ประเภท
      <input type="text" class="form-control" placeholder="ชื่อประเภท" v-model="type"></label>
      <div class="d-flex justify-content-end m-2">
        <button class="btn btn-sm btn-success" @click="submitCreate()">Submit</button>
      </div>
    </div>
...
export default {
  ...
  submitCreate(){
      ...
      axios.post(`${DB_URL}/stock/type.json`,{type:this.type}).then((result) => {
