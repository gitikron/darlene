    ...
    <div class="block-center">
      ...
      <!--right-->
        ...
        <div class="bg-dark brt-3">
          ...
          <label for="address" class="text-white">คอร์สคงเหลือ</label>
          </div>
          <div class="card bg-dark badge d-flex justify-content-center mx-2">
          <table class="table table-hover text-white mt-2" id="datatable" cellspacing="0" width="100%">
                  <thead>
                    <tr class="px-0">
                      <th class="fs-res mx-0 px-0 col-6">list</th>
                      <th class="fs-res mx-0 px-0 col-2">คงเหลือ</th>
                      <th class="fs-res mx-0 px-0 col-4 text-center">EXP</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
