...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <label for="price" class="mt-2">ราคา</label>
      <input type="number" class="form-control mt-2" placeholder="Price" v-model="edit.arr.price" @change="calCuedit()">

      <label for="amount" class="mt-2">จำนวน</label><span class="text-danger">{{textspanEdit}}</span>
      <input type="number" class="form-control mt-2" placeholder="amount" v-model="edit.arr.amount" @change="calCuedit()">
...
export default {
  ...
  methods: {
    ...
    calCuedit(){
        ...
        if(this.edit.arr.amount<=-0){
          this.PricePerUnit=0
          this.textspanEdit=' (ต้องมากกว่า 0)'
          return false
        }
        this.textspan=''
