      ...
      >
        <thead>
          <tr>
            ...
            <th class="fs-res">นามสกุล</th>
            <th class="fs-res">ชื่อเบ่น</th>
            <th class="fs-res">เบอร์โทร</th>
            <th class="fs-res">เพศ</th>
            <th class="fs-res">
        ...
        <tbody>
          <tr v-for="item in arr" :key="item.username">
            <td class="fs-res">{{ item.firstname }}</td>
            <td class="fs-res">{{ item.lastname }}</td>
            <td class="fs-res">{{ item.nickname }}</td>
            <td class="fs-res">{{ item.phone }}</td>
            <td class="fs-res">{{ item.sex }}</td>
            <td class="fs-res">
              <span class="material-symbols-outlined text-black-50">sync_lock</span>
            </td>
            <td class="fs-res">
