<template>
  <div>
    ...
    <div>
      ...
      <input type="number" class="form-control mt-2" placeholder="ประมวลผลอัตโนมัติ" v-model="PricePerUnit" disabled>
...
export default {
  ...
  methods: {
    calCu(){
      ...
      if(this.create.amount<=-1){
        return false
      }
      const PricePerUnit=parseInt(this.create.amount)/parseInt(this.create.price)
