      ...
      >
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0 text-center"><input type="text"><button class="btn btn-sm btn-succcess">></button></td>
            <td class="fs-res mx-0 px-0 text-center"><input type="text"><button class="btn btn-sm btn-danger">></button></td>
