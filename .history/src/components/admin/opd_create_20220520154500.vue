...
<div>
    {{newOpd}}
      ...
      <div class="form-group row mt-2" v-if="cd===true">
        ...
        <button class="btn btn-sm btn-outline-dark m-2 w-100-res" @click="newOpd.Disease= 'DM'">DM</button>
        <button class="btn btn-sm btn-outline-dark m-2 w-100-res" @click="newOpd.Disease= 'HT'">HT</button>
        <button class="btn btn-sm btn-outline-dark m-2 w-100-res" @click="newOpd.Disease= 'DLD'">DLD</button>
        <button class="btn btn-sm btn-outline-dark m-2 w-100-res" @click="newOpd.Disease= 'HT/DM'">HT/DM</button>
        <button class="btn btn-sm btn-outline-dark m-2 w-100-res" @click="newOpd.Disease= 'HT/DLD'">HT/DM</button>
        <button class="btn btn-sm btn-outline-dark m-2 w-100-res" @click="newOpd.Disease= 'DM/DLD'">HT/DM</button>
        <button class="btn btn-sm btn-outline-dark m-2 w-100-res" @click="newOpd.Disease= 'HT/DM/DLD'">HT/DM/DLD</button>
        </div>
