<template>
  <div>
    ...
    <div class="card m-2 p-2" v-if="switchs===true">
      ...
      <select id="position" class="form-control mt-2" v-model="personal.position">
         <option value="">เลือก</option>
        <option value="salary doctor">salary doctor</option>
        <option value="part-time doctor">part-time doctor</option>
      </select>
