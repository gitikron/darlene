...
<div>
    {{newOpd}}
      ...
      <div class="form-group row mt-2">
        ...
        <div class="col-sm-10">
          <input type="text" pattern="[A-Za-z]{3}" class="form-control" id="firstname" placeholder="firstname" v-model='newOpd.firstname'>
        </div>
      </div>
      <div class="form-group row mt-2">
      ...
      <div class="form-group row mt-2">
        ...
        <div class="col-sm-10">
          <input type="text" pattern="[0-9]" class="form-control" id="personalID" placeholder="เลขประจำตัวประชาชน" v-model='newOpd.personalID' >
        </div>
      </div>
    </form>
  </div>
