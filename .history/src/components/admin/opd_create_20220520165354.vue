...
<div>
    {{newOpd}}
      ...
      <div class="form-group row mt-2">
        ...
        <!-- ส่วนของที่อยู่ -->
      <div v-if="addA===true">
            <div class="container form-group row mt-5 mx-auto">
             ...
             <label for="Alley">ซอย
              ...
              <div class="col-sm-2 px-0 mx-auto">
             <label for="Lane">แยห
                <input type="text" class="form-control form-control-sm" id="villageNo" placeholder="หมู่ที่" v-model='newOpd.address.Lane'></label>
              </div>
