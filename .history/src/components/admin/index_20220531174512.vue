    ...
    <div class="block-center">
      <div class="card block-1">
        ...
        <div class="float-start" v-if="load==='couse'">
          ...
          <button class="btn btn-sm btn-warning" @click="selected(item.couseName)" :disabled="item.section===true">เลือก</button>
          </div>
          </div>
...
export default {
  ...
  methods: {
    selected(Name){
      console.log(Name)
      console.log(this.selectedA.length)
      console.log(this.selectedA[1].couseName)
