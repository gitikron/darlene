...
<div>
    {{newOpd}}
      ...
      <div v-if="addA===true">
            <div class="form-group row mt-2">
              <label for="lastname" class="col-sm-2 col-form-label">House number</label>
              <div class="col-sm-2">
              ...
              <label for="lastname" class="col-sm-2 col-form-label">House number</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="House" placeholder="หมู่บ้าน/อาคาร" v-model='newOpd.address.Village'>
              </div>

              <label for="lastname" class="col-sm-2 col-form-label">House number</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="House" placeholder="หมู่ที่" v-model='newOpd.address.VillageNo'>
              </div>
