<template>
  <div>
    <img :src="create.display" alt="demoDisplay" class="100px" v-if="create.display!=''">
     <div>
      <label for="upload">Display</label>
    <input accept="image/*" class="mt-10 w-100 form-control" type="file"  @change="onFileSelected($event,index)"/>
     </div>
    <div>
