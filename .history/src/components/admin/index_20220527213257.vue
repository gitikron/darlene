    ...
    <div class="block-center">
      <div class="card block-1">
        <div class="float-sm-start">
          ...
          <div v-for="item,index in couse" :key="index" class="btn btn-outline-primary card block-3 m-2 p-1">
          ...
          <span class="fw-semibold fs-10 text-center mt-1">{{item.price}} บาท / {{item.per}} ครั้ง</span>
          <span class="text-end">{{item.per}}</span>
          </div>
