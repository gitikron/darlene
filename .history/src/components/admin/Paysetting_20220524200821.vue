...
<div>
  <div class="d-flex justify-content-end"> 
    <label for="promtpay" class="form-control">promtpay No.
    <input type="text" name="promtpay" class="form-control-sm" placeholder="promtpay number">
    <button class="btn btn-sm btn-success mx-2">Submit</button>
    </label>
    <button class="btn btn-sm btn-primary m-2" @click="change()">create</button>
    </div>
  ...
  <!--table-->
      <div class="mt-2" v-if="create===false">
       <table class="table table-hover mt-2" id="datatable" cellspacing="0" width="100%">
        <thead>
          <tr class="px-0">
            <th class="fs-res mx-0 px-0">list</th>
            <th class="fs-res mx-0 px-0">วิธีการหัก</th>
            <th class="fs-res mx-0 px-0">หักจำนวน</th>
