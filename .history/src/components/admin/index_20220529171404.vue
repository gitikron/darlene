  ...
  <div class="block-0 m-0 p-0">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- body -->
         <select id="position" class="form-control mt-2" v-model="queue.section">
          <option value="">เลือกสถานะ</option>
          <option value="Todoctor">พบแพทย์</option>
          <option value="Totherapist">therrapist</option>
      </select>
       <select id="position" class="form-control mt-2" v-model="queue.mdSelect">
          <option value="">เลือกแพทย์</option>
          <option v-for="item,index in doctor[0]" :key="index" :value="item.username" >{{item.name}}</option>
      </select>
      <label v-if="queue.section==='Totherapist'" for="need" class="form-control mt-2">จำนวน thepapist ที่ให้บริการ
        <input type="number" id="need" v-model="queue.need" class="form-control"  placeholder="จำนวน thepapist ที่ให้บริการ">
      </label>
