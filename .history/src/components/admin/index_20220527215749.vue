    ...
    <div class="block-center">
      <div class="card block-1">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark brt-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#" @click="load='index'">Home</a>
          </li>
          <li class="nav-item">
        ...
        <div class="float-start">
          ...
          <span class="fw-semibold fs-10 text-center mt-1">{{item.price}} บาท</span>
          <span class="fw-semibold fs-10 text-center mt-1"> {{item.per}} ครั้ง</span>
          </div>
          </div>
