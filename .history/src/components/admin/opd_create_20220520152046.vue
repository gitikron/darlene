...
<div>
    {{newOpd}}
      ...
      <div class="form-group row mt-2">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" id="CD" placeholder="Congenital Disease" v-model='newOpd.congenitalDisease' >
        </div>
        <div class="col-sm-2 mt-1">
      ...
      <div class="form-group row mt-2" v-if="cd===true">
        <button @click="newOpd.congenitalDisease='HT'">HT</button>
        <button @click="newOpd.congenitalDisease= 'DM'">DM</button>
         <button @click="newOpd.congenitalDisease= 'HT/DM'">HT/DM</button>
      </div>
