    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="number" class="form-control" v-model="reArr.amount" disabled>

          <input type="number" class="form-control" v-model="input" @change="calcu(reArr.amount,input)">

          <input type="number" class="form-control" v-model="outter">
