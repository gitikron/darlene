  ...
  <div class="card m-0 p-2">
    ...
    <div>
      <label for="Stock" class="mx-2">
       ...
       <button  class="btn btn-sm btn-primary" :disabled="Setting.main===false" @click="testSend('stock',Setting.lineStock)">test</button> 
       </label>
       ...
       <button class="btn btn-sm btn-primary" :disabled="Setting.main===false" @click="testSend('account',Setting.lineAccount)">test</button>
       </label>
