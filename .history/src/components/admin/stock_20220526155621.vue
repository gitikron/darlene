...
export default {
  ...
  methods: {
   post() {
const url = 'https://notify-bot.line.me/oauth/authorize?response_type=code&client_id='+command.Client_ID+'&redirect_uri=http://localhost:8080/#/admin&scope=notify&state='+command.Users
     axios.get(url)
// axios({
//     method: 'post',
