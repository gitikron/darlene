        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0 text-center">
              <button class="btn btn-sm material-symbols-outlined" data-bs-toggle="modal" data-bs-target="#editModal" @click="repass.data=item,repass.index=index,editModel(index)">key</button>
            </td>
            <td class="fs-res mx-0 px-0 text-center">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- body -->
          <input type="text" min="8" max="32" class="form-control mt-2" placeholder="Username" v-model="repass.data.username">
          
          <input type="text" v-model="repass.data.role">
          <input type="text" v-model="repass.data.position">
          <input type="password" min="8" max="32" class="form-control mt-2" placeholder="Password" v-model="repass.password1">
          <input type="password" min="8" max="32" class="form-control mt-2" placeholder="Confirm Password" v-model="repass.password2">
          <!-- body -->
        </div>
