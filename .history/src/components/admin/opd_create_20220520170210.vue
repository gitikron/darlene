...
<div>
    {{newOpd}}
      ...
      <div class="form-group row mt-2">
        <label for="personalID" class="col-sm-2 col-form-label">Address</label>
        <div class="col-sm-10">
          <input type="text" maxlength="10" inputmode="numeric" pattern="[0-9]*" class="form-control" id="phone" placeholder="ที่อยู่" v-model='newOpd.phone' >
        </div>
      </div>
