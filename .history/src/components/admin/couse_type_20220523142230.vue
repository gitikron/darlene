      ...
      >
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0">
              <button class="btn btn-btn-outline-danger btn-sm material-symbols-outlined" data-bs-toggle="modal" data-bs-target="#editModal" @click="delType(index)">delete</button>
            </td>
          </tr>
        </tbody>
      </table>
