      ...
      >
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0 mx-2">
                 <button class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#editModal">เข้า</button>
            </td>
            <td class="fs-res mx-0 px-0 text-center d-flex justify-content-center">
              <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#editModal">ออก</button>
            </td>
