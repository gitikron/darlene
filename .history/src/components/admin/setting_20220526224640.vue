<template>
  <div class="card m-2 w-blog">
    ...
    <div v-if="Setting.main===true">
      <label for="Stock" class="mx-2">Stock
       <input type="text" class="form-control-md m-2" v-model="Setting.lineStock">
       <button  class="btn btn-sm btn-primary">test</button> 
       </label>
       <label for="Account"  class="mx-2">Account
       <input type="text" class="form-control-md m-2" v-model="Setting.lineAccount">
       <button class="btn btn-sm btn-primary">test</button>
       </label>
       {{Setting}}
