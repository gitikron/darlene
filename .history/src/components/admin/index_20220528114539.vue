      ...
      <div class="card block-1">
        ...
        <nav class="navbar navbar-expand-lg navbar-primary bg-primary brt-2 mb-3">
          <ul class="navbar-nav mx-auto d-block">
            ...
            <button class="btn btn-sm btn-primary m-2" @click="load='couse'" v-if="customers!=''">คอร์ส</button>
            <button class="btn btn-sm btn-primary m-2" @click="load='item'" v-if="customers!=''">สินค้า</button>
          </ul>
            ...
            <table class="table table-hover mt-2" id="datatable" cellspacing="0" width="100%">
                  <thead>
                    <tr class="px-0">
                      ...
                      <th class="fs-res mx-0 px-0">sale</th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    <tr v-for="item,index in OPD" :key="index">
                      ...
                      <td></td>
                      <td></td>
                      <td><button class="btn btn-sm">sale</button></td>
                    </tr>
                  </tbody>
                </table>
             </div>
      ...
      <!--right-->
        ...
        <div class="bg-dark brt-3">
          <div class=" d-flex justify-content-start m-2">
              ...
              <input type="text" name="OPD" id="OPD" class="form-control" placeholder="OPD NUMBER" disabled>
          </div>
          <div class=" d-flex justify-content-start m-2">
              <label for="Name" class="text-white col-4"> ชื่อ-นามสกุล  </label>
              <input type="text" name="Name" id="Name" class="form-control" placeholder="ชื่อ-นามสกุล" disabled>
          </div>
          <div class=" d-flex justify-content-start m-2">
              <label for="nickname" class="text-white col-4">ชื่อเล่น</label>
              <input type="text" name="nickname" id="nickname" class="form-control" placeholder="ชื่อเล่น" disabled>
          </div>
          <div class=" d-flex justify-content-start m-2">
              <label for="phone" class="text-white col-4">เบอร์โทร</label>
              <input type="text" name="phone" id="phone" class="form-control" placeholder="เบอร์โทร" disabled>
          </div>
          
          <div class=" d-flex justify-content-start m-2">
              <label for="nickname" class="text-white col-4">โรคประจำตัว</label>
              <textarea class="form-control" id="nickname" rows="3" disabled/>
          </div>
          <div class=" d-flex justify-content-start m-2">
              <label for="address" class="text-white col-4">ที่อยู่</label>
              <textarea class="form-control" id="address" rows="3" disabled/>
          </div>
          <div class=" d-flex justify-content-center mt-4 ">
            <button class="btn btn-sm btn-info mx-auto">clear</button>
          <button class="btn btn-sm btn-primary mx-auto">use remaining</button>
          <button class="btn btn-sm btn-warning mx-auto">history</button>
          </div>
          <div class=" d-flex justify-content-center mt-4">
