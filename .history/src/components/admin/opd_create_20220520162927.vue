...
<div>
    {{newOpd}}
      ...
      <div v-if="addA===true">
            <div class="form-group row mt-2">
              <label for="lastname" class="col-sm-2 col-form-label">number</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="lastname" placeholder="House Number" v-model='newOpd.lastname'>
              </div>
            </div>
      </div>
