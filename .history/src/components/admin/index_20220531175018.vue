    ...
    <div class="block-center">
      <div class="card block-1">
        ...
        <div class="float-start" v-if="load==='couse'">
          <div v-for="item,index in selectedA" :key="index" class="btn btn-outline-dark card block-3 m-1 p-1" :disabled="item.select===true">
          ...
          <button class="btn btn-sm btn-danger mt-1" @click="selectedOut(index)" :disabled="item.select===false">เลือก</button>
          </div>
          </div>
