        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0 mx-2">
                  <input type="number" class="form-control col-10">
                  <button class="btn btn-success col-2">></button>
            </td>
            <td class="fs-res mx-0 px-0 text-center mx-2">
              <input type="number" class="form-control col">
                <button class="btn btn-danger col-2">></button>
            </td>
