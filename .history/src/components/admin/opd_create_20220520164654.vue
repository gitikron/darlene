      ...
      <div v-if="addA===true">
            <div class="form-group row mt-5">
              ...
              <div class="col-sm-1 px-0">
                <input type="text" class="form-control  form-control-sm" id="House" placeholder="บ้านเลขที่" v-model='newOpd.address.number'>
              </div>

              <label for="room" class="col-sm-1 col-form-label text-end">ห้อง</label>
              <div class="col-sm-1 px-0">
                <input type="text" class="form-control form-control-sm" id="room" placeholder="ห้อง" v-model='newOpd.address.room'>
              </div>
