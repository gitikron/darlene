    ...
    {{newOpd}}
      ...
      <div v-if="addA===true">
            <div class=" form-group row mt-5 mx-auto">
              <div class="col-sm-2 px-0 mx-auto">
              <label for="House">บ้านเลขที่ 
                <input type="text" class="form-control" id="House" placeholder="บ้านเลขที่" v-model='newOpd.address.number'></label>
              </div>
              <div class="col-sm-2 px-0 mx-auto">
              <label for="room" >ห้อง
                <input type="text" class="form-control" id="room" placeholder="ห้อง" v-model='newOpd.address.room'></label>
              </div>
              <div class="col-sm-2 px-0 mx-auto">
              <label for="Village">อาคาร
                <input type="text" class="form-control" id="Village" placeholder="หมู่บ้าน/อาคาร" v-model='newOpd.address.Village'></label>
              </div>
              <div class="col-sm-2 px-0 mx-auto">
             <label for="villageNo">หมู่ที่
                <input type="text" class="form-control" id="villageNo" placeholder="หมู่ที่" v-model='newOpd.address.VillageNo'></label>
              </div>
            </div>
          ...
          <div class=" form-group row mt-2 mx-auto">
             <div class="col-sm-2 px-0 mx-auto">
             <label for="Alley">ซอย
                <input type="text" class="form-control form-control-sm" id="Alley" placeholder="หมู่ที่" v-model='newOpd.address.Alley'></label>
              </div>
              <div class="col-sm-2 px-0 mx-auto">
             <label for="Lane">แยก
                <input type="text" class="form-control form-control-sm" id="Lane" placeholder="แยก" v-model='newOpd.address.Lane'></label>
              </div>
              <div class="col-sm-4 px-0 mx-auto">
             <label for="Road">ถนน
                <input type="text" class="form-control form-control-sm" id="Road" placeholder="แยก" v-model='newOpd.address.Road'></label>
              </div>
