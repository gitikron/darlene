  ...
  <div class="block-0 m-0 p-0">
    <div class="block-center">
      <div class="card block-1">
        <div>
        <nav class="navbar navbar-expand-lg navbar-primary bg-primary brt-2">
          <ul class="navbar-nav mx-auto d-block">
            <button class="btn btn-sm btn-dark m-2" @click="load='opd',getOPD()">OPD</button>
        ...
        <div class="float-start" v-if="load==='couse'">
          ...
          <button class="btn btn-sm btn-warning">เลือก</button>
           ...
           <div class="card p-3" v-if="load==='opd'">
