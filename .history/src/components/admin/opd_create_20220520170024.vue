      ...
      <div v-if="addA===true">
            <div class=" form-group row mt-5 mx-auto">
              ...
              <label for="Village">อาคาร
                <input type="text" class="form-control form-control-sm" id="Village" placeholder="หมู่บ้าน/อาคาร" v-model='newOpd.address.Village'></label>
              </div>
              <div class="col-sm-2 px-0 mx-auto">
             <label for="villageNo">หมู่ที่
                <input type="text" class="form-control form-control-sm" id="villageNo" placeholder="หมู่ที่" v-model='newOpd.address.VillageNo'></label>
              </div>
            </div>
          ...
          <div class=" form-group row mt-2 mx-auto">
             ...
             <label for="Road">ถนน
                <input type="text" class="form-control form-control-sm" id="Road" placeholder="ถนน" v-model='newOpd.address.Road'></label>
              </div>
               <div class="col-sm-4 px-0 mx-auto">
             <label for="Road">ตำบล
                <input type="text" class="form-control form-control-sm" id="Road" placeholder="ตำบล" v-model='newOpd.address.Road'></label>
              </div>
