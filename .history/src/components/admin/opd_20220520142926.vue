...
<div>
  ...
  <div class="container card m-2 p-3">
    {{newOpd}}
      <form>
      ...
      <div class="form-group row mt-2">
        <label for="lastname" class="col-sm-2 col-form-label">Sex</label>
          <div class="form-check col-sm-5 mt-2 d-flex justify-content-center">
            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" v-if="newOpd.sex==='ชาย'"
       checked="checked">
          ...
          <div class="form-check col-sm-5 mt-2">
