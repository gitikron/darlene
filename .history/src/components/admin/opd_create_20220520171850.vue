...
<div>
    ...
    <div class="alert alert-danger" role="alert" v-if="alert.control===true">
      <div class="d-flex">
      <div class="justify-content-start">{{alert.text}}</div>
      <div class="d-flex justify-content-end"><span>x</span></div></div>
    </div>
      <form>
...
export default {
  ...
  methods: {
    ...
    CreateOpdCard(){
      this.alert.text='somthing went worg'
