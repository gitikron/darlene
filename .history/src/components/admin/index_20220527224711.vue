      ...
      <div class="card block-1">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark brt-2">
          <ul class="navbar-nav mx-auto d-block">
            ...
            <button class="btn btn-sm btn-dark m-2" @click="load='couse'">คอร์ส</button>
            <button class="btn btn-sm btn-dark m-2" @click="load='item'">สินค้า</button>
          </ul>
        ...
        <div class="float-start" v-if="load==='couse'">
          ...
          <div v-for="item,index in item" :key="index" class="btn btn-outline-dark card block-3 m-2 p-1">
          <img :src="item.display" alt="itme display" class="img-card">
          ...
          <button class="btn btn-sm btn-warning">เลือก</button>
           ...
           <div class="d-block" v-if="load==='opd'">
