...
<div >
  <table
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0">
              <button  @click="editModel(index)" class="btn btn-outline-dark btn-sm material-symbols-outlined" data-bs-toggle="modal" data-bs-target="#editModal">edit</button>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <!-- Modal -->
      <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true" v-if="modalEdit===true">
