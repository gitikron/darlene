...
<div>
    {{newOpd}}
      ...
      <div class="form-group row mt-2">
        ...
        <div class="col-sm-10">
          <input type="number" maxlength="11" inputmode="numeric" pattern="[0-9]*" class="form-control" id="personalID" placeholder="เลขประจำตัวประชาชน" v-model='newOpd.personalID' >
        </div>
      </div>
    </form>
  </div>
