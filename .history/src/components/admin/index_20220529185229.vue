    ...
    <div class="block-center">
      <div class="card block-1">
        ...
        <div class="float-start" v-if="load==='couse'">
          <div v-for="item,index in couse" :key="index" class="card block-3 m-1 p-1">
          ...
          <button class="btn btn-sm btn-warning" disabled>เลือก</button>
          </div>
          </div>

          <div class="float-start" v-if="load==='item'">
          <button v-for="item,index in item" :key="index" class="btn btn-outline-dark card block-3 m-1 p-1">
           <div class="d-flex justify-content-center">
            <img :src="item.display" alt="itme display" class="img-card">
           </div>
