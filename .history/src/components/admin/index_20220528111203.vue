      ...
      <!--right-->
        ...
        <div class="bg-dark brt-3">
          <div class=" d-flex justify-content-start m-2">
              <label for="OPD" class="text-white col-4"> OPD  </label>
              <input type="text" name="" id="" class="form-control" placeholder="OPD NUMBER" disabled>
          </div>
          <div class=" d-flex justify-content-start m-2">
              <label for="OPD" class="text-white col-4"> ชื่อ-นามสกุล  </label>
              <input type="text" name="" id="" class="form-control" placeholder="ชื่อ-นามสกุล" disabled>
          </div>
          <div class=" d-flex justify-content-start m-2">
              <label for="OPD" class="text-white col-4">ชื่อเล่น</label>
              <input type="text" name="" id="" class="form-control" placeholder="ชื่อเล่น" disabled>
          <div>
