      ...
      >
        <thead>
          <tr class="px-0">
            ...
            <th class="fs-res mx-0 px-0">Description</th>
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index" class="row">
            <td class="col-3 fs-res mx-0 px-0"> <img class="display-100" :src="item.display" alt=""></td>
            <td class="col-3 fs-res mx-0 px-0">{{item.couseName}}</td>
            <td class="fs-res mx-0 x-0">{{ item.description }}</td>
