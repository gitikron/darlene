        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0">
              <button class="btn btn-sm material-symbols-outlined" data-bs-toggle="modal" data-bs-target="#editModal" @click="editModel(index)">key</button>
            </td>
            <td class="fs-res mx-0 px-0">
              <button class="btn btn-sm material-symbols-outlined" data-bs-toggle="modal" data-bs-target="#editModal" @click="deleteModel(index)">delete</button>
            </td>
          </tr>
        </tbody>
      </table>
