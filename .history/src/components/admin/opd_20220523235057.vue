...
<div>
  <div class="d-flex justify-content-end pb-2">
    ...
    <div class="d-flex justify-content-end m-2">
      <button class="btn btn-sm btn-dark" @click="OpenNew()">แสดงตัวอย่าง</button>
    </div>
...
export default {
  ...
  methods: {
    OpenNew(){
      window.open('https://docs.google.com/spreadsheets/d/14z7Lx2WAx-cVLTPUcDiJiGz8rgY-6kaF/edit?usp=sharing&ouid=110027634825332139242&rtpof=true&sd=true')
    },
    getOpdnum(){
