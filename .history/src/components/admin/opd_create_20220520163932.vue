...
<div>
    {{newOpd}}
      ...
      <div v-if="addA===true">
            <div class="form-group row mt-2">
              <label for="House" class="col-sm-1 col-form-label text-end">บ้านเลขที่ </label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="House" placeholder="บ้านเลขที่" v-model='newOpd.address.number'>
              </div>

              <label for="room" class="col-sm-1 col-form-label text-end">ห้อง</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="room" placeholder="ห้อง" v-model='newOpd.address.room'>
              </div>

              <label for="Village" class="col-sm-1 col-form-label text-end">หมู่บ้าน/อาคาร</label>
              <div class="col-sm-2">
            ...
            <div class="form-group row mt-2">
             <label for="villageNo" class="col-sm-2 col-form-label text-end">หมู่ที่ : </label>
              <div class="col-sm-2">
