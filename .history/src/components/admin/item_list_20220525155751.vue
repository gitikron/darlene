      ...
      >
        ...
        <tbody>
          <tr v-for="item,index in arr" :key="index">
            ...
            <td class="fs-res mx-0 px-0 text-center">{{item.price}}</td>
            <td class="fs-res mx-0 px-0 text-center">{{item.amount}}</td>
            <td class="fs-res mx-0 px-0 text-center">{{item.PricePerUnit+" : 1 "+item.unit}}</td>
